...
xgb_models["pH_next"].save_model("models/xgboost_pH_next.json")
xgb_models["Tur_next"].save_model("models/xgboost_Tur_next.json")
xgb_models["Cond_next"].save_model("models/xgboost_Cond_next.json")
